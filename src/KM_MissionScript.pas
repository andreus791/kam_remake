...
type
  ...
  TKMCommandType = (ct_Unknown=0,ct_SetMap,ct_SetMaxPlayer,ct_SetCurrPlayer,ct_HumanPlayer,ct_UserPlayer,ct_SetHouse,
                    ...
                    ct_SetHouseDamage,ct_SetUnitByStock,ct_UnitAddToLast,ct_SetGroup,ct_SetGroupFood,ct_SetGroupHunger,ct_SendGroup,
...
const
  COMMANDVALUES: array [TKMCommandType] of AnsiString = (
    ...
    'ADD_UNIT_TO_LAST','SET_GROUP','SET_GROUP_FOOD','SET_GROUP_HUNGER','SEND_GROUP','ATTACK_POSITION','ADD_WARE_TO_SECOND',
